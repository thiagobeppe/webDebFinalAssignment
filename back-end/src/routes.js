...
routes.get("/dashboard-admin/", PetController.listpetsdashuser);
routes.get("/dashboard-admin/pets", PetController.listpetsdashadmin);
...
routes.get("/pets/aprovepet/:id", PetController.aprovepet);
routes.get("/pets/desaprovepet/:id", PetController.desaprovepet);
